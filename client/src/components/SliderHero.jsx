...
const ArrowNext = (props) => {
  ...
  return (
    <button
      className=" z-10 absolute top-1/2 right-0 opacity-60 md:-right-14 md:opacity-100"
      onClick={onClick}
    >
      <svg
        className="w-8 h-8 md:w-14 md:h-14 fill-gray-500"
        viewBox="0 0 26 43"
        fill="none"
...
const ArrowPrev = (props) => {
  ...
  return (
    <button
      className=" z-10 absolute top-1/2 left-0 rotate-180 opacity-60 md:-left-14 md:opacity-100"
      onClick={onClick}
    >
      <svg
        className="w-8 h-8 md:w-14 md:h-14 fill-gray-500"
