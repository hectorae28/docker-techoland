...
class ImagenProducto(models.Model):
    product = models.ForeignKey(
        Producto, on_delete=models.CASCADE, related_name="ProductoImagen"
    )
...
class Grosor(models.Model):
    product = models.ForeignKey(
        Producto, on_delete=models.CASCADE, related_name="ProductoGrosor"
    )
...
class Color(models.Model):
    grosor = models.ForeignKey(
        Grosor, on_delete=models.CASCADE, related_name="GrosorColores"
    )
